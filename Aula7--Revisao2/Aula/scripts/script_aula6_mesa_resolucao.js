...
//Capturando o elemento Pai (Deve estar fora do laço de repetição)
let elementoPai = document.getElementById("elementoPai");

/* Define a função que renderiza os elementos pegos da lista de objetos em tela */
function percorreListaFelinos() {

    //Percorrendo a lista de felinos
    for (let felino of listafelinos) {

        //Cria o card que representa cada felino
        let card =
            `
        ...
        //Adiciona uma nova classe a div recem criada
        novoNo.classList.add("item")
...
//Invoca a função (Executa a função)
